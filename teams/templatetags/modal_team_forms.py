...
@register.inclusion_tag('registration/change_team_name.html',
                        takes_context=True)
...
@register.inclusion_tag('registration/change_team_password.html',
                        takes_context=True)
...
@register.inclusion_tag('registration/promote_demote.html',
                        takes_context=True)
def show_promote_demote_form(context, target_username, promote):
    initial = {
        'target_username': target_username,
        'promote': promote
    }
    context.update(
        {'form': team_forms.PromoteOrDemotePlayer(initial=initial)}
    )
    return context


@register.inclusion_tag('registration/appoint_captain.html',
                        takes_context=True)
def show_appoint_captain_form(context, target_username):
    initial = {'target_username': target_username}
